...
class TestPhase5MitigationPrecedence(unittest.TestCase):
    def test_overlapping_modifiers_use_highest_values(self) -> None:
        result = run_scenario_file(Path("scenarios/smoke/phase5_mitigation_precedence_basic.json"))
        ...
        self.assertEqual(save_damage["weakness_total"], 5)
        self.assertEqual(save_damage["applied_total"], save_damage["raw_total"] + 5)
